...
del lab11.lst	REM helloworld可以替換成.asm檔的檔名
del lab11.obj
del lab11.ilk
del lab11.pdb
del lab11.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:lab11.exe lab11.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
